...
export default function Popular() {
  ...
  return (
    <MainLayout title="Darloo - Popular Products">
      <div className="py-5 bg-transparent text-black z-10 w-full min-h-[50vh] flex flex-col gap-5 relative px-4 sm:px-[3rem] ">
        ...
        >
          ...
          {isGerman ? "Top Trending Produkte" : "Top Trending Products"}
        </h1>
        {/* Desktop Grid View */}
        <div className="hidden sm:grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-3 auto-rows-fr">
          {isLoading
