    ...
    <div className="relative" ref={searchRef}>
      <div className="relative">
        ...
        <input
          ...
          className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md leading-5 bg-gray-50 placeholder-gray-600 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-red-500 focus:border-red-500 sm:text-sm"
        />
        {searchTerm && (
          <button
            onClick={clearSearch}
      ...
      {showResults && (
        <div className="absolute z-50 mt-1 w-full bg-white rounded-md shadow-lg max-h-80 overflow-y-auto shidden border border-gray-200">
          {loading ? (
