  ...
  return (
    ...
    >
      {products.map((product) => (
        <SwiperSlide
          key={product._id}
          className="group bg-white min-w-[17rem] backdrop-blur-sm rounded-xl border  shadow-xl overflow-hidden transition-all duration-300 hover:shadow-[#9333EA]/20 hover:shadow-2xl dark:hover:border-[#9333EA]/50 hover:border-[#9333EA]/50 hover:-translate-y-1"
        >
